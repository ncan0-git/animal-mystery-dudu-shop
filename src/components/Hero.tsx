      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 py-8 lg:py-16">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[70vh]">
            ...
            <div className="text-center space-y-6 lg:space-y-8 order-2 lg:order-1 relative py-12 px-8">
              {/* Background rectangle */}
              <div className="absolute inset-0 bg-muted/80 rounded-2xl -z-10"></div>
